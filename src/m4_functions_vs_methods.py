...
def try_methods():
    ...
    ###########################################################################
    aid = rg.SimpleTurtle('turtle')
    aid.pen = rg.Pen('brown',5)
...
def try_methods_and_functions():
    ...
    cam.pen = rg.Pen('blue',5)

    cam.speed = 1

    draw_many_squares(cam,2,100,30)

    cam.speed = 5
    cam.pen = rg.Pen('red',5)

    draw_many_squares(cam,10,50,15)

    cam.speed = 100
    cam.pen = rg.Pen('red',35)

    draw_many_squares(cam,8,300,60)

    cam.pen = rg.Pen('black',3)
