...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, and Nasser_Hegar.
...
def main():
    ...
    turtle_pens(color_1,thickness_1)
    turtle_pens(color_2,thickness_2)
...
def turtle_pens(color,thickness):
    ...
    natasha = rg.SimpleTurtle('circle')

    boris.pen = rg.Pen('green',thickness)
    natasha.pen = rg.Pen(str(color),5)
