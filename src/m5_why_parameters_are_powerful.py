...
def main():
    ...
    #even_better_draw_circles(rg.Point(100,50),30,5,'red',1)
    #even_better_draw_circles(rg.Point(-200,0),5,20,'blue',1)

    even_better_draw_circles(rg.Point(-100,100),10,8,'green',18)
    even_better_draw_circles(rg.Point(100, 100), 10, 8, 'green', 18)
    even_better_draw_circles(rg.Point(0, 0), 15, 8, 'blue', 18)
...
def better_draw_circles(point,radius_dif):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radius_dif)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radius_dif * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point,radius_dif,circles,color,thickness):
